...
interface IconProps {
  name: 'arrow' | 'download' | 'sparkles' | 'write';
  className?: string;
}
...
export const RobotIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.353-.026.692-.026 1.038 0 1.13.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5M8.25 7.5v3.75c0 1.135.845 2.098 1.976 2.192.353-.026.692-.026 1.038 0 1.13.094 1.976 1.057 1.976 2.192V18.75M15.75 18.75v-1.875a2.25 2.25 0 0 0-2.25-2.25h-1.5a2.25 2.25 0 0 0-2.25 2.25V18.75m0 0h-9m9 0H21m-9 0h-3.375a2.25 2.25 0 0 0-2.25 2.25c0 .097.03.19.085.274.056.085.121.16.197.232l3.375 3.375c.62.62 1.62.62 2.24 0l3.375-3.375a1.5 1.5 0 0 0 .282-.506c.055-.084.085-.177.085-.274a2.25 2.25 0 0 0-2.25-2.25H15.75Z" />
    </svg>
);
...
export const ShortsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 10.5l4.5 3-4.5 3v-6Z" />
    </svg>
);
...
export const TranscriptIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 16.5l4.5-3-4.5-3v6Z" />
    </svg>
);
...
export const DescriptionIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ChapterIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
    </svg>
);

export const NameIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    ...
    >
      <path
        d="M21 5.25H3c-1.1046 0-2 .8954-2 2v9.5c0 1.1046.8954 2 2 2h18c1.1046 0 2-.8954 2-2v-9.5c0-1.1046-.8954-2-2-2z"
        stroke="#ef4444"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M9.5 15.25V8.75L15.5 12L9.5 15.25z"
        fill="#ef4444"
      />
      <path
        d="M17.5 8.75l-.25-.975a1.5 1.5 0 00-1.2-1.2l-.975-.25.975-.25a1.5 1.5 0 001.2-1.2l.25-.975.25.975a1.5 1.5 0 001.2 1.2l.975.25-.975.25a1.5 1.5 0 00-1.2 1.2l-.25.975z"
        fill="#ef4444"
      />
    </svg>
);
